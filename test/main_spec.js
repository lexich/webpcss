...
describe("webpcss", ()=> {
  ...
  it("html tag", ()=> {
    ...
    return transform(input).then((res)=> {
      expect(input + "\nhtml.webp.test { background: url(test.webp); }")
        .to.be.eql(res.css);
    });
  });
  ...
  it("border-radius css property", ()=> {
    ...
    return transform(input).then((res)=> {
      expect(input + "\n.webp .test { border-image: url(test.webp); }")
        .to.be.eql(res.css);
    });
  });
  ...
  it(".html classname", ()=> {
    var input = ".html.test { background: url('test.png'); }";
    return transform(input).then((res)=> {
      expect(input + "\n.webp .html.test { background: url(test.webp); }")
        .to.be.eql(res.css);
    });
  });
  ...
  it("multiple selectors", ()=> {
    ...
    return transform(input).then((res)=> {
      expect(input + "\n.webp .test1, .webp .test2 { background: url(test.webp); }")
        .to.be.eql(res.css);
    });
  });
  ...
  it("default options background with url", ()=> {
    ...
    transform(input).then((res)=> {
      expect(input + "\n.webp .test { background: url(test.webp); }")
        .to.be.eql(res.css);
    });
  });
  ...
  it("default options background with url and params", ()=> {
    ...
    return transform(input).then((res)=> {
      expect(input + "\n.webp .test { background: transparent url(test.webp) no-repeat; }")
        .to.be.eql(res.css);
    });
  });
  ...
  it("default options background with gif and jpg", ()=> {
    ...
    return transform(input).then((res)=> {
      expect(input + "\n.webp .test { background: url(test.gif), url(test1.webp); }")
        .to.be.eql(res.css);
    });
  });
  ...
  it("replace_to && replace_from", ()=> {
    ...
    return transform(input, { replace_to: ".$1.webp" }).then((res)=> {
      expect(input + "\n.webp .icon { background-image: url(../images/icon.png.webp); }")
        .to.be.eql(res.css);
    });
  });
